...
class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("bf4b77f2-c599-11ed-afa1-0242ac120002");
    private final UUID RESTAURANT_ID = UUID.fromString("dad5b654-c599-11ed-afa1-0242ac120002");
    private final UUID PRODUCT_ID = UUID.fromString("e06546c0-c599-11ed-afa1-0242ac120002");
    private final UUID ORDER_ID = UUID.fromString("f354b220-c599-11ed-afa1-0242ac120002");
    ...
    void testCreateOrder() {
        ...
        assertThat(createOrderResponse.getOrderTrackId()).isNotNull();
    }
    ...
    void testCreateOrderWithWrongProductPrice() {
        assertThatThrownBy(() -> {
            orderApplicationService.createOrder(createOrderCommandWrongProductPrice);
                ...
                .hasMessage("Order item price: 60.00 is not valid for product for product " + PRODUCT_ID);
    }
    ...
    void testCreateOrderWithPassiveRestaurant() {
        ...
        assertThatThrownBy(() -> {
            orderApplicationService.createOrder(createOrderCommand);
                ...
                .hasMessage("Restaurant with id " + RESTAURANT_ID
